...
func (s *Stocks) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     s.ID,
		Type:   "Stocks",
	...
	var buf []byte
	if buf, err = json.Marshal(s.Symbol); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(s.NameJa); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(s.Exchange); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(s.ExchangeShortName); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(s.Price); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "float64",
	...
	if buf, err = json.Marshal(s.Industry); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(s.MarketCarp); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "float64",
	...
	if buf, err = json.Marshal(s.LastDiv); err != nil {
		return nil, err
	}
	node.Fields[9] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(s.Website); err != nil {
		return nil, err
	}
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	switch table {
	case stocks.Table:
		n, err := c.Stocks.Query().
			Where(stocks.ID(id)).
			CollectFields(ctx, "Stocks").
			Only(ctx)
		if err != nil {
			return nil, err
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	switch table {
	case stocks.Table:
		nodes, err := c.Stocks.Query().
			Where(stocks.IDIn(ids...)).
			CollectFields(ctx, "Stocks").
			All(ctx)
		if err != nil {
			return nil, err
